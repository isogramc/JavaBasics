...
(window.onload = function onLoadFn() { // Anonymous function defines a local scope
 ...
 for(var c = root.firstChild; c != null; c == c.nextSibling) {
       ...
       for(var h = 0; h < headings.length; h++) {
        ...
        // Do a check on whether it is the first time a span is added with this sectionNumber
 
        if (sectionNumber === heading.firstChild.innerHTML){
